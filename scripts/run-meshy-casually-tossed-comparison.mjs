...
const objects = [
  {
    objectId: "pink-striped-shag-sweater",
    name: "Pink Striped Shag Sweater",
    materialClass: "knit-fuzzy",
  },
  {
    objectId: "navy-taffeta-dress",
    name: "Navy Taffeta Dress",
    materialClass: "crisp-woven",
  },
  {
...
try {
  ...
  run = {
    schemaVersion: 1,
    runId: "meshy-casually-tossed-comparison-20260728",
    purpose: "Compare image-reconstructed floor poses against cloth simulation",
