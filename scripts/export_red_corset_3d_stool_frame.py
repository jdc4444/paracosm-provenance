...
OUTPUT = os.path.join(
    ROOT, "public/archive/objects/3d/tests/red-corset-3d-stool-sim"
)
FRAME = 80
...
settled = bpy.data.objects.new("Red_Corset_Stool_Drape_Frame80", settled_mesh)
...
bpy.ops.export_scene.gltf(
    filepath=os.path.join(
        OUTPUT, "red-corset-3d-stool-sim-frame80.glb"
    ),
    export_format="GLB",
    use_selection=True,
    export_apply=True,
...
bpy.ops.wm.save_as_mainfile(
    filepath=os.path.join(
        OUTPUT, "red-corset-3d-stool-sim-frame80.blend"
    )
)

print(
    "CORSET_STOOL_FRAME_EXPORT_COMPLETE",
    "frame",
    FRAME,
    "faces",
